...
testthat::test_that("expect equal", {
  ...
  issue = c("consent_telephone_number is selected but telephone_number is not found in the dataset",
            "consent_telephone_number is selected but telephone_number is not found in the dataset",
            "consent_telephone_number is selected but telephone_number is not found in the dataset",
            "consent_telephone_number is selected but telephone_number is not found in the dataset",
            "consent_telephone_number is selected but telephone_number is not found in the dataset"
  ), check_id = c("id- 27", "id- 27", "id- 27", "id- 27", "id- 27"
  ), check_binding = c("id- 27 ~/~ f58a7fda-27e8-4003-90b3-479bebbb99ab",
  ...
  expected <- structure(list(uuid = c("f58a7fda-27e8-4003-90b3-479bebbb99ab",
                             ...
                             issue = c("shelter_occupation_other has value but the shelter_occupation column is not other(Not matching with kobo relevancy.)",
                             ...
                             check_binding = c("id- 28 ~/~ f58a7fda-27e8-4003-90b3-479bebbb99ab",
  ...
  expected <- structure(list(uuid = c("f58a7fda-27e8-4003-90b3-479bebbb99ab",
                             ...
                             check_binding = c("id- 35 ~/~ f58a7fda-27e8-4003-90b3-479bebbb99ab",
