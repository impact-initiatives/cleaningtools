...
testthat::test_that("Testing the function is working as expected",
                    ...
                    {testthat::expect_no_error({
                      ...
                      testthat::expect_equal(object = create_validation_list(choices = cleaningtools_choices ,tool = cleaningtools_survey)$change_type_validation[1:4],
                                             expected = c("change_response", "blank_response", "remove_survey", "no_action"))


                      testthat::expect_equal(object = create_validation_list(choices = cleaningtools_choices ,tool = cleaningtools_survey)$consent_share_location[1:2],
                                             expected = c("yes", "no"))
