...
testthat::test_that("Checking with test data", {
  ...
  cleaing_log_actual <- create_cleaning_log(
    raw_dataset = test_raw_data, raw_dataset_uuid_column = "uuid",
  ...
  testthat::expect_equal(nrow(review_cleaning_log(
    raw_dataset = test_raw_data, raw_dataset_uuid_column = "uuid",
    clean_dataset = test_clean_data, clean_dataset_uuid_column = "uuid",
  ...
  cleaing_log_actual <- create_cleaning_log(
    raw_dataset = test_raw_data, raw_dataset_uuid_column = "X_uuid",
    clean_dataset = test_clean_data, clean_dataset_uuid_column = "uuid",
    check_for_deletion_log = T,
    check_for_variable_name = F
  ) |> dplyr::select(dplyr::all_of(names(expected_cleaning_log)))
...
testthat::test_that("create cleaning log with no deletion survey", {
  ...
  expected <- structure(list(
    uuid = c(
      ...
      "my_old_var", "my_new_var", "expenditure",
      "gender", "expenditure", "gender", "expenditure", "gender"
    ),
    change_type = c(
      "variable_removed", "variable_added", "change_response",
  ...
  expected_v2 <- structure(list(uuid = c(
    "5", "all", "all", "2", "2", "4", "4",
    "3", "3"
  ), question_name = c(
    NA, "my_old_var", "my_new_var",
    "expenditure", "gender", "expenditure", "gender", "expenditure",
    "gender"
  ), change_type = c(
    "added_survey", "variable_removed",
    "variable_added", "change_response", "change_response", "change_respose",
    "change_respose", "blank_response", "blank_response"
  ), new_value = c(
    NA,
...
testthat::test_that("Test related to deletion and added surveys", {
  ...
  testthat::expect_no_error(create_cleaning_log(
    raw_dataset = me_raw_data, raw_dataset_uuid_column = "uuid",
  ...
  testthat::expect_equal(nrow(review_cleaning_log(
    raw_dataset = me_raw_data, raw_dataset_uuid_column = "uuid", clean_dataset = me_clean_data, clean_dataset_uuid_column = "uuid",
  ...
  testthat::expect_no_error(review_cleaning_log(
    raw_dataset = me_raw_data, raw_dataset_uuid_column = "uuid", clean_dataset = me_clean_data, clean_dataset_uuid_column = "uuid",
    cleaning_log = cl_test, cleaning_log_uuid_column = "uuid", cleaning_log_change_type_column = "change_type",
    cleaning_log_question_column = "question_name", cleaning_log_new_value_column = "new_value",
    cleaning_log_old_value_column = "old_value", deletion_log = dl_test, deletion_log_uuid_column = "uuid",
  ...
  expected <- structure(
    list(
      uuid = "6", df.question_name = NA_character_,
  ...
  testthat::expect_equal(nrow(create_cleaning_log(
    raw_dataset = me_raw_data, raw_dataset_uuid_column = "uuid", check_for_deletion_log = F,
  ...
  cl_test <- structure(list(
    uuid = "6", question_name = NA_character_, change_type = "added_survey",
    new_value = NA_character_, old_value = NA_character_, comment = "Survey added to the clean dataset."
...
testthat::test_that("Test related to deletion and added surveys", {
  ...
  expected <- structure(
    list(
      ...
      df.change_type = c(
        "remove_survey", "added_survey", "change_response",
  ...
  ## error msg check
  testthat::expect_error(review_cleaning_log(
    raw_dataset = test_raw_data, raw_dataset_uuid_column = "uuid",
    clean_dataset = test_clean_data,
    clean_dataset_uuid_column = "uuid",
    cleaning_log = test_cleaning_log,
