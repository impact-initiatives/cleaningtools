...
testthat::test_that("implement cleaning log",{
  ...
  clean_data_fi <- create_clean_data(df = cleaningtools::raw_data,df_uuid = "X_uuid",
                                          cl = cleaningtools::cleaning_log,
                                          cl_change_type_col = "change_type",
                                          cl_change_col =  "questions",cl_new_val = "new_value",
                                          cl_uuid = "X_uuid")
  expect_equal(nrow(clean_data_fi),nrow(cleaningtools::clean_data))


  ## check_multiple input
  cleaning_log_1 <- cleaningtools::cleaning_log
  ...
  clean_data_multiple <- create_clean_data(df = cleaningtools::raw_data,df_uuid = "X_uuid",
                                     cl = cleaning_log_1,
                                     cl_change_type_col = "change_type",
 ...
 expect_equal(nrow(review_cleaning_log(raw_data = cleaningtools::raw_data,raw_data_uuid = "X_uuid",
...
#####
 ...
 #no_action
 expect_equal(cleaningtools::raw_data[cleaningtools::raw_data$X_uuid == "bc6df6b9-c888-4cd3-9198-a52f3a1eb677","air_coolers_hours"],
 clean_data_multiple[clean_data_multiple$X_uuid == "bc6df6b9-c888-4cd3-9198-a52f3a1eb677","air_coolers_hours"])

 # no change
 expect_equal(cleaningtools::raw_data[cleaningtools::raw_data$X_uuid == "f949f8ee-6536-4627-a850-dc0b092ba379","air_coolers_nb"],
              clean_data_multiple[clean_data_multiple$X_uuid == "f949f8ee-6536-4627-a850-dc0b092ba379","air_coolers_nb"])


  #### NA check
  cleaning_log_na <- cleaningtools::cleaning_log
  cleaning_log_na$change_type[[1]] <- NA

  expect_error(create_clean_data(df = cleaningtools::raw_data,df_uuid = "X_uuid",
                    cl = cleaning_log_na,
                    cl_change_type_col = "change_type",
  ...
  expect_equal(nrow(check_cleaning_log(df = cleaningtools::raw_data,df_uuid = "X_uuid",
                    cl = cleaning_log_na,
                    cl_change_type_col = "change_type",
                    cl_change_col =  "questions",cl_new_val = "new_value",
                    cl_uuid = "X_uuid")),1)
...
### wrong question
  cleaning_log_wrong <- cleaningtools::cleaning_log %>% dplyr::mutate(
    questions = cleaningtools::cleaning_log$questions %>% stringr::str_replace_all("treat_drink_water","treat_drink_water2"))
  ...
  expect_output(check_cleaning_log(df = cleaningtools::raw_data,df_uuid = "X_uuid",
                                   cl = cleaning_log_wrong,
                                   values_for_change_response = "change_response",
                                   cl_change_type_col = "change_type",
                                   cl_change_col =  "questions",cl_new_val = "new_value",
...
testthat::test_that("check cleaning log",{
  ...
  expect_no_error(check_cleaning_log(df = cleaningtools::raw_data,df_uuid = "X_uuid",cl = cleaningtools::cleaning_log,
                                     cl_change_type_col = "change_type",
                                     values_for_change_response = "change_response",cl_change_col = "questions",
                                     cl_uuid = "X_uuid",cl_new_val = "new_value"))

  expect_error(check_cleaning_log(df = cleaningtools::raw_data,df_uuid = "X_uuid",cl = cleaningtools::cleaning_log,
                                  cl_change_type_col = "change_type",
