...
test_that("expect equal", {
  ...
  expected_df <- structure(list(id = c("id- 1", "id- 2", "id- 3", "id- 4", "id- 5",
  ...
  ), logic = c("(water_sources.other == TRUE | water_sources.other == 1 ) & !is.na(water_sources.other)",
  ...
  ), description = c("water_sources.other is selected but water_sources_other is not found in the dataset",
  ...
  ), variables_to_clean_column = c("water_sources.other", "water_source_drinking",
