...
testthat::test_that("expect equal ", {
  ...
  expected <- structure(list(uuid = c("ac26e24d-12be-4729-bae7-21060ee00a28", "all", "all", "all", "all", "all", "e8b1ba82-59df-4910-b9c8-29bc3fd516ab"
  ), question = c("X_index", "neighbourhood", "water_supply_rest_neighbourhood",
...
############ test_with_diff list
  ...
  expected <- structure(list(id1 = c("ac26e24d-12be-4729-bae7-21060ee00a28", "all", "all", "all", "all", "all", "e8b1ba82-59df-4910-b9c8-29bc3fd516ab"
  ), primary_key = c(NA, "a", "a", "a", "a", "a", "a"),
  question = c("X_index", "neighbourhood", "water_supply_rest_neighbourhood",
                  "water_supply_other_neighbourhoods", "water_supply_other_neighbourhoods_why",
                  "consent_telephone_number", "X_index"),
