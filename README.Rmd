...
`create_cleaning_log` function takes raw data and clean data as inputs and its identify any changes bwtween them and finally provide the output as cleaning log format.
``` {r, eval=FALSE}
...
recreate_parent_column(df = pre_clean_test,uuid = "uuid",sm_sep = ".")
