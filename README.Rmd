...
#### 3.5 Check logics
`check_for_logical()` takes a regular expression, as it is how it will be read from Excel `check_for_logical_with_list()`.
```{r}
