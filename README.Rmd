...
devtools::load_all()
deletaion_log <- cleaningtools::cleaningtools_cleaning_log |> filter(change_type == "remove_survey")
cleaning_log2 <- cleaningtools::cleaningtools_cleaning_log |> filter(change_type != "remove_survey")
options(scipen = 999)
